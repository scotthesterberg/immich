...
import { asset_face_source_type, asset_visibility_enum, assets_status_enum, person_type_enum } from 'src/schema/enums';
import {
  album_delete_audit,
...
export class ImmichDatabase {
  ...
  enum = [assets_status_enum, asset_face_source_type, asset_visibility_enum, person_type_enum];
}
