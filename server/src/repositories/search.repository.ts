...
export class SearchRepository {
  ...
  searchFaces(options: FaceEmbeddingSearch) {
    const { userIds, embedding, numResults, maxDistance, hasPerson, minBirthDate, type } = options;
      ...
      return await trx
        .with('cte', (qb) =>
          qb
            ...
            .$if(!!type, (qb) => qb.where('asset_face.type', '=', type!))
